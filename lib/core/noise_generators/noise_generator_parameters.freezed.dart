...
class _$NoiseGeneratorParametersImpl implements _NoiseGeneratorParameters {
  ...
  @override
  String toString() {
    return 'NoiseGeneratorParameters(frequency: $frequency, amplitude: $amplitude, lowPassCutoff: $lowPassCutoff, highPassCutoff: $highPassCutoff, smoothingFactor: $smoothingFactor)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, frequency, amplitude,
      lowPassCutoff, highPassCutoff, smoothingFactor);
...
abstract class _NoiseGeneratorParameters implements NoiseGeneratorParameters {
  const factory _NoiseGeneratorParameters(
      ...
      required final double smoothingFactor}) = _$NoiseGeneratorParametersImpl;
